...
g510s.o: g510s.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall `pkg-config --cflags gtk+-3.0 appindicator3-0.1` -c g510s.c -o g510s.o

g510s-clock.o: g510s-clock.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall -c g510s-clock.c -o g510s-clock.o

g510s-config.o: g510s-config.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall -c g510s-config.c -o g510s-config.o

g510s-keys.o: g510s-keys.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall -c g510s-keys.c -o g510s-keys.o

g510s-list.o: g510s-list.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall -c g510s-list.c -o g510s-list.o

g510s-misc.o: g510s-misc.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall -c g510s-misc.c -o g510s-misc.o

g510s-net.o: g510s-net.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall -c g510s-net.c -o g510s-net.o

g510s-signals.o: g510s-signals.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall `pkg-config --cflags gtk+-3.0` -c g510s-signals.c -o g510s-signals.o

g510s-threads.o: g510s-threads.c g510s.h
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall `pkg-config --cflags appindicator3-0.1` -c g510s-threads.c -o g510s-threads.o
...
g510s: g510s.o g510s-clock.o g510s-config.o g510s-keys.o g510s-list.o g510s-misc.o g510s-net.o g510s-signals.o g510s-threads.o
	$(CC) $(CFLAGS) $(LDFLAGS) -fcommon -Wall g510s.o g510s-clock.o g510s-config.o g510s-keys.o g510s-list.o g510s-misc.o g510s-net.o g510s-signals.o g510s-threads.o -o g510s -lg15 -lg15render -lpthread -rdynamic `pkg-config --libs gtk+-3.0 appindicator3-0.1`
